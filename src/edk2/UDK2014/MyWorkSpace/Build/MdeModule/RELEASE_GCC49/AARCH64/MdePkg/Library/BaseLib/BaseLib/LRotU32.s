...
// options passed:  -fpreprocessed LRotU32.i -mcmodel=large -mlittle-endian
// -auxbase-strip /root/next-loader/src/edk2/UDK2018/MyWorkSpace/Build/MdeModule/RELEASE_GCC49/AARCH64/MdePkg/Library/BaseLib/BaseLib/OUTPUT/./LRotU32.obj
...
LRotU32:
.LFB0:
	.file 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/LRotU32.c"
	.loc 1 39 0
	.cfi_startproc
.LVL0:
	sub	sp, sp, #32	//,,
...
.L2:
	...
	mov	w0, 32	// tmp89,
	sub	w0, w0, w19	// D.2832, tmp89, Count
	lsr	w0, w20, w0	// D.2831, Operand, D.2832
	lsl	w19, w20, w19	// D.2831, Operand, Count
.LVL3:
	.loc 1 42 0
	orr	w0, w0, w19	//, D.2831, D.2831
	ldr	x30, [sp,16]	//,
	ldp	x19, x20, [sp]	//,,
.LVL4:
	add	sp, sp, 32	//,,
...
.LC0:
	.string	"/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/LRotU32.c"
.LC2:
	.string	"Count < 32"
	.text
.Letext0:
