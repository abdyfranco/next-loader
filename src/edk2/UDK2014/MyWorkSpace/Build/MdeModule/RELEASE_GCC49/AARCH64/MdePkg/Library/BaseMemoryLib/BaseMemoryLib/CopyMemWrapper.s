...
// options passed:  -fpreprocessed CopyMemWrapper.i -mcmodel=large
// -mlittle-endian
// -auxbase-strip /root/next-loader/src/edk2/UDK2018/MyWorkSpace/Build/MdeModule/RELEASE_GCC49/AARCH64/MdePkg/Library/BaseMemoryLib/BaseMemoryLib/OUTPUT/./CopyMemWrapper.obj
...
CopyMem:
.LFB0:
	.file 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/CopyMemWrapper.c"
	.loc 1 52 0
	.cfi_startproc
.LVL0:
	sub	sp, sp, #32	//,,
	...
	.cfi_offset 30, -8
	.loc 1 52 0
	mov	x19, x0	// DestinationBuffer, DestinationBuffer
	mov	x21, x1	// SourceBuffer, SourceBuffer
	mov	x20, x2	// Length, Length
	.loc 1 53 0
	cbz	x2, .L3	// Length,
	.loc 1 56 0
...
.LVL1:
	...
	sub	x0, x20, #1	// D.2655, Length,
	mvn	x1, x19	// D.2655, DestinationBuffer
	cmp	x0, x1	// D.2655, D.2655
	bls	.L4	//,
	ldr	x0, .LC1	//,
	ldr	x2, .LC3	//,
	mov	x1, 56	//,
...
.LVL3:
	...
	sub	x0, x20, #1	// D.2655, Length,
	mvn	x1, x21	// D.2655, SourceBuffer
	cmp	x0, x1	// D.2655, D.2655
	bls	.L5	//,
	ldr	x0, .LC1	//,
	ldr	x2, .LC5	//,
...
.L5:
	...
	cmp	x19, x21	// DestinationBuffer, SourceBuffer
	beq	.L3	//,
	.loc 1 62 0
	mov	x0, x19	//, DestinationBuffer
	mov	x1, x21	//, SourceBuffer
	mov	x2, x20	//, Length
	.loc 1 63 0
	ldp	x21, x30, [sp,16]	//,,
.LVL5:
...
.LC0:
	.string	"/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/CopyMemWrapper.c"
.LC2:
