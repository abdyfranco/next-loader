# 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/SetJump.c"
...
# 1 "<command-line>" 2
# 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/SetJump.c"
# 18 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/SetJump.c"
...
# 19 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/SetJump.c" 2
# 31 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/SetJump.c"
void
...
{
  do { if (DebugAssertEnabled ()) { if (!(JumpBuffer != ((void *) 0))) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/SetJump.c", 37, "JumpBuffer != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));

  do { if (DebugAssertEnabled ()) { if (!(((UINTN)JumpBuffer & (8 - 1)) == 0)) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseLib/SetJump.c", 39, "((UINTN)JumpBuffer & (8 - 1)) == 0"); ; } } } while (((BOOLEAN)(0==1)));
}
