...
// options passed:  -fpreprocessed UefiBootServicesTableLib.i
// -mcmodel=large -mlittle-endian
// -auxbase-strip /root/next-loader/src/edk2/UDK2018/MyWorkSpace/Build/MdeModule/RELEASE_GCC49/AARCH64/MdePkg/Library/UefiBootServicesTableLib/UefiBootServicesTableLib/OUTPUT/./UefiBootServicesTableLib.obj
...
.Ltext0:
	...
	.align	2
	.global	UefiBootServicesTableLibConstructor
	.type	UefiBootServicesTableLibConstructor, %function
UefiBootServicesTableLibConstructor:
.LFB0:
	.file 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/UefiBootServicesTableLib/UefiBootServicesTableLib.c"
	.loc 1 46 0
	.cfi_startproc
.LVL0:
	sub	sp, sp, #32	//,,
	...
	.loc 1 50 0
	str	x0, [x20]	// ImageHandle, gImageHandle
	.loc 1 51 0
...
.LVL1:
	...
	ldr	x0, [x20]	// gImageHandle, gImageHandle
	cbnz	x0, .L2	// gImageHandle,
	ldr	x0, .LC2	//,
	ldr	x2, .LC4	//,
	mov	x1, 51	//,
	bl	DebugAssert	//
...
.L3:
	...
	ldr	x20, .LC8	// tmp95,
	ldr	x0, [x19,96]	// SystemTable_11(D)->BootServices, SystemTable_11(D)->BootServices
	str	x0, [x20]	// SystemTable_11(D)->BootServices, gBS
	.loc 1 63 0
	bl	DebugAssertEnabled	//
.LVL5:
	uxtb	w0, w0	// D.8040,
...
.LC1:
	.string	"/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/UefiBootServicesTableLib/UefiBootServicesTableLib.c"
.LC3:
...
.LASF238:
	.string	"StartImage"
.LASF281:
	.string	"/root/next-loader/src/edk2/UDK2018/MyWorkSpace/Build/MdeModule/RELEASE_GCC49/AARCH64/MdePkg/Library/UefiBootServicesTableLib/UefiBootServicesTableLib"
.LASF99:
