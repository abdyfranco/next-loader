# 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/IsZeroBufferWrapper.c"
...
# 1 "<command-line>" 2
# 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/IsZeroBufferWrapper.c"
# 26 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/IsZeroBufferWrapper.c"
...
# 27 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/IsZeroBufferWrapper.c" 2
# 44 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/IsZeroBufferWrapper.c"
BOOLEAN
...
{
  do { if (DebugAssertEnabled ()) { if (!(!(Buffer == ((void *) 0) && Length > 0))) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/IsZeroBufferWrapper.c", 51, "!(Buffer == ((void *) 0) && Length > 0)"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!((Length - 1) <= (0xFFFFFFFFFFFFFFFFULL - (UINTN)Buffer))) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/IsZeroBufferWrapper.c", 52, "(Length - 1) <= (0xFFFFFFFFFFFFFFFFULL - (UINTN)Buffer)"); ; } } } while (((BOOLEAN)(0==1)));
