# 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c"
...
# 1 "<command-line>" 2
# 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c"
# 25 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c"
...
# 26 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c" 2
# 46 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c"
void *
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if (!(Buffer != ((void *) 0))) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c", 58, "Buffer != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!((Length - 1) <= (0xFFFFFFFFFFFFFFFFULL - (UINTN)Buffer))) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c", 59, "(Length - 1) <= (0xFFFFFFFFFFFFFFFFULL - (UINTN)Buffer)"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!((((UINTN)Buffer) & (sizeof (Value) - 1)) == 0)) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c", 60, "(((UINTN)Buffer) & (sizeof (Value) - 1)) == 0"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!((Length & (sizeof (Value) - 1)) == 0)) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/SetMem16Wrapper.c", 61, "(Length & (sizeof (Value) - 1)) == 0"); ; } } } while (((BOOLEAN)(0==1)));
