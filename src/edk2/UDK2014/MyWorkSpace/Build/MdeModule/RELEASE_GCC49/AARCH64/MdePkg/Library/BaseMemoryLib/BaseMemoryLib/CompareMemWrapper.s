...
// options passed:  -fpreprocessed CompareMemWrapper.i -mcmodel=large
// -mlittle-endian
// -auxbase-strip /root/next-loader/src/edk2/UDK2018/MyWorkSpace/Build/MdeModule/RELEASE_GCC49/AARCH64/MdePkg/Library/BaseMemoryLib/BaseMemoryLib/OUTPUT/./CompareMemWrapper.obj
...
CompareMem:
.LFB0:
	.file 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/CompareMemWrapper.c"
	.loc 1 56 0
	.cfi_startproc
.LVL0:
	sub	sp, sp, #32	//,,
	...
	.cfi_offset 30, -8
	.loc 1 56 0
	mov	x20, x1	// SourceBuffer, SourceBuffer
	mov	x21, x0	// DestinationBuffer, DestinationBuffer
	mov	x19, x2	// Length, Length
	.loc 1 57 0
	cbz	x2, .L2	// Length,
	cmp	x0, x1	// DestinationBuffer, SourceBuffer
	beq	.L2	//,
	.loc 1 60 0
...
.LVL5:
	...
	sub	x0, x19, #1	// D.2667, Length,
	mvn	x1, x21	// D.2667, DestinationBuffer
	cmp	x0, x1	// D.2667, D.2667
	bls	.L5	//,
	ldr	x0, .LC1	//,
	ldr	x2, .LC7	//,
	mov	x1, 62	//,
...
.LVL7:
	...
	sub	x0, x19, #1	// D.2667, Length,
	mvn	x1, x20	// D.2667, SourceBuffer
	cmp	x0, x1	// D.2667, D.2667
	bls	.L6	//,
	ldr	x0, .LC1	//,
	ldr	x2, .LC9	//,
...
.L6:
	...
	mov	x0, x21	//, DestinationBuffer
	mov	x1, x20	//, SourceBuffer
	mov	x2, x19	//, Length
	.loc 1 66 0
	ldp	x21, x30, [sp,16]	//,,
.LVL9:
...
.LC0:
	.string	"/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/CompareMemWrapper.c"
.LC2:
