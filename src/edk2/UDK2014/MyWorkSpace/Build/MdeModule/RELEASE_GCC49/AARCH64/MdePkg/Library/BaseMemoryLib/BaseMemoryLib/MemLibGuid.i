# 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c"
...
# 1 "<command-line>" 2
# 1 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c"
# 26 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c"
...
# 27 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c" 2
# 43 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c"
GUID *
...
# 77 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c"
BOOLEAN
...
# 119 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c"
void *
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if (!(((UINTN)Buffer & (sizeof (Guid->Data1) - 1)) == 0)) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c", 129, "((UINTN)Buffer & (sizeof (Guid->Data1) - 1)) == 0"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!(Length <= (0xFFFFFFFFFFFFFFFFULL - (UINTN)Buffer + 1))) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c", 130, "Length <= (0xFFFFFFFFFFFFFFFFULL - (UINTN)Buffer + 1)"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!((Length & (sizeof (*GuidPtr) - 1)) == 0)) { DebugAssert ("/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c", 131, "(Length & (sizeof (*GuidPtr) - 1)) == 0"); ; } } } while (((BOOLEAN)(0==1)));
...
# 158 "/root/next-loader/src/edk2/UDK2018/MyWorkSpace/MdePkg/Library/BaseMemoryLib/MemLibGuid.c"
BOOLEAN
