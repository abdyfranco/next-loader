...
/*
 * Next Loader NOTE: This file is included only when compiling with GNU-EFI,
 ...
 * used name (LOADER_EFI_COMPONENT_NAME_PROTOCOL) to the traditional
 * name (EFI_COMPONENT_NAME_PROTOCOL) in fsw_efi.c for compiling with
 * TianoCore.
 */

#ifndef __LOADER_EFI_COMPONENT_NAME_H__
#define __LOADER_EFI_COMPONENT_NAME_H__

///
/// The global ID for the Component Name Protocol.
///
#define LOADER_EFI_COMPONENT_NAME_PROTOCOL_GUID \
  { \
    0x107a772c, 0xd5e1, 0x11d4, {0x9a, 0x46, 0x0, 0x90, 0x27, 0x3f, 0xc1, 0x4d } \
  }

typedef struct _LOADER_EFI_COMPONENT_NAME_PROTOCOL  LOADER_EFI_COMPONENT_NAME_PROTOCOL;


/**
  Retrieves a Unicode string that is the user-readable name of the EFI Driver.

  @param  This       A pointer to the LOADER_EFI_COMPONENT_NAME_PROTOCOL instance.
...
typedef
EFI_STATUS
(EFI_FUNCTION EFIAPI *LOADER_EFI_COMPONENT_NAME_GET_DRIVER_NAME)(
  IN LOADER_EFI_COMPONENT_NAME_PROTOCOL    *This,
  IN  CHAR8                                *Language,
...
typedef
EFI_STATUS
(EFI_FUNCTION EFIAPI *LOADER_EFI_COMPONENT_NAME_GET_CONTROLLER_NAME)(
  IN  LOADER_EFI_COMPONENT_NAME_PROTOCOL                      *This,
...
///
struct _LOADER_EFI_COMPONENT_NAME_PROTOCOL {
  LOADER_EFI_COMPONENT_NAME_GET_DRIVER_NAME      GetDriverName;
  LOADER_EFI_COMPONENT_NAME_GET_CONTROLLER_NAME  GetControllerName;
  ///
